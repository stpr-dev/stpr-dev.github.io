...
I ended part 2 wondering if there is some jank with Windows and USB serial throughput/reliability. I've established what I think is an upper limit on throughput with my Go code. I was still not entirely convinced that the reliability was good, so I decided to do three things today:
...
- Run the test harnesses on four different computers using both Windows and Linux to see if the results I was observing last time were fluke or there is actual merit to them.
...
- Unlike Windows, Linux doesn't heavily penalise smaller frame sizes. 
- The peak throughput was also higher for Linux than for Windows.
...
OK, this is maybe a fluke. Let's look at a different machine. Here is the 9800X3D one:
...
# Footnotes
- Side rant: I am always annoyed by secure boot and having to disable it to boot from the live USB. I wish it were plug-and-play.
